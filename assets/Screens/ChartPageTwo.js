...
const ChartPageTwo = (p) => {
  ...
  return (
    ...
    <View style={{flex:1, backgroundColor:'#01796F'}}>
       ...
       <Text style={{color:'white', fontSize:responsiveFontSize(3)}}>Predictive Maintenance</Text>
      ...
      <View style={{flexDirection:'row', justifyContent:'space-between', marginRight:responsiveWidth(4), marginLeft:responsiveWidth(4), marginTop:responsiveHeight(1)}}>
  ...
  <View style={{flexDirection:'row', marginTop:responsiveHeight(1), justifyContent:'space-between', marginRight:responsiveWidth(3), marginLeft:responsiveWidth(30)}}>
  <View style={{flexDirection:'row', justifyContent:'center', alignItems:'center'}}>
    <View style={{backgroundColor:"rgb(0,255,0)", borderRadius:100, width:responsiveWidth(5), height:responsiveHeight(2.5)}}></View>
    <Text style={{fontSize: responsiveFontSize(2), marginLeft:responsiveWidth(3), color:'white', fontWeight:'bold'}}>Charging</Text>
  </View>
  <View style={{flexDirection:'row' , justifyContent:'center', alignItems:'center'}}>
    <View style={{backgroundColor:"red", width:responsiveWidth(5), borderRadius:100, height:responsiveHeight(2.5)}}></View>
    <Text style={{fontSize: responsiveFontSize(2),  marginLeft:responsiveWidth(4), color:'white', fontWeight:'bold'}}>Discharging</Text>
  </View>
  </View>
  </View>
...
function TemperatureCurve() {
  return(
       ...
       <View>
      <View style={{flexDirection:'row', justifyContent:'space-between', marginRight:responsiveWidth(4), marginLeft:responsiveWidth(4), marginTop:responsiveHeight(3)}}>
  ...
  <View style={{flexDirection:'row', marginTop:responsiveHeight(1), justifyContent:'space-between', marginRight:responsiveWidth(3), marginLeft:responsiveWidth(65)}}>
  <View style={{flexDirection:'row' , justifyContent:'center', alignItems:'center'}}>
    <View style={{backgroundColor:"red", width:responsiveWidth(5), borderRadius:100, height:responsiveHeight(2.5)}}></View>
    <Text style={{fontSize: responsiveFontSize(2),  marginLeft:responsiveWidth(4), color:'white', fontWeight:'bold'}}>Discharging</Text>
  </View>
...
function BatteryUsage() {
  return(
       ...
       <View>
      <View style={{flexDirection:'row', justifyContent:'space-between', marginRight:responsiveWidth(4), marginLeft:responsiveWidth(4), marginTop:responsiveHeight(3)}}>
        <Text style={{fontSize: responsiveFontSize(2), color:'white', fontWeight:'bold'}}>Battery Usage</Text>
        <View style={{flexDirection:'row'}}>
        <Text style={{fontSize: responsiveFontSize(2), color:'white', fontWeight:'bold'}}>19 </Text>
        <Text style={{fontSize: responsiveFontSize(1.5), color:'white', fontWeight:'bold'}}> hrs</Text>
        <Text style={{fontSize: responsiveFontSize(2), color:'white', fontWeight:'bold'}}> 25 </Text>
  ...
  <View style={{flexDirection:'row', marginTop:responsiveHeight(1), justifyContent:'space-between', marginRight:responsiveWidth(3), marginLeft:responsiveWidth(67)}}>
  
  <View style={{flexDirection:'row' , justifyContent:'center', alignItems:'center'}}>
    <View style={{backgroundColor:"blue", width:responsiveWidth(5), borderRadius:100, height:responsiveHeight(2.5)}}></View>
    <Text style={{fontSize: responsiveFontSize(2),  marginLeft:responsiveWidth(4), color:'white', fontWeight:'bold'}}>Usage</Text>
  </View>
  </View>
